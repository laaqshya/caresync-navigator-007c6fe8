...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    welcomeCareSync: 'Welcome to CareSync',
  ...
  es: {
    ...
    welcomeCareSync: 'Bienvenido a CareSync',
    selectRole: 'Seleccione su rol para comenzar',
